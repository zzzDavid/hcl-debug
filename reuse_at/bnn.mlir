module {
  func.func @top(%arg0: memref<1x1x16x16xi1>, %arg1: memref<16x1x3x3xi1>) -> memref<1x16x16x16xi6> attributes {itypes = "uu", otypes = "s"} {
    ...
    %1 = memref.alloc() {name = "conv1"} : memref<1x16x16x16xi6>
    affine.for %arg2 = 0 to 1 {
      affine.for %arg3 = 0 to 16 {
        affine.for %arg4 = 0 to 16 {
          affine.for %arg5 = 0 to 16 {
            %8 = memref.alloc() {name = "conv1_sum"} : memref<1xi6>
            %c0_i32 = arith.constant 0 : i32
            %c0 = arith.constant {unsigned} 0 : index
            %9 = arith.trunci %c0_i32 : i32 to i6
            affine.store %9, %8[0] {to = "conv1_sum"} : memref<1xi6>
            affine.for %arg6 = 0 to 3 {
              affine.for %arg7 = 0 to 3 {
                ...
                // scf.if %true {
                  ...
                  %66 = arith.extsi %c1_i32_12 : i32 to i33
                  ...
                  %71 = arith.extsi %c1_i32_13 : i32 to i34
                  %72 = arith.subi %70, %71 : i34
                  %73 = arith.trunci %72 : i34 to i6
                  %c0_i32_14 = arith.constant 0 : i32
                  %74 = arith.trunci %c0_i32_14 : i32 to i6
                  %75 = arith.select %58, %73, %74 : i6
                  %76 = affine.load %8[0] {from = "conv1_sum"} : memref<1xi6>
                  %77 = arith.extsi %75 : i6 to i7
                  %78 = arith.extsi %76 : i6 to i7
                  %79 = arith.addi %77, %78 : i7
                  %80 = arith.trunci %79 : i7 to i6
                  affine.store %80, %8[0] {to = "conv1_sum"} : memref<1xi6>
                // }
              } {loop_name = "rx", reduction}
            } {loop_name = "ry", reduction}
            %10 = affine.load %8[0] {from = "conv1_sum"} : memref<1xi6>
            affine.store %10, %1[%arg2, %arg3, %arg4, %arg5] {to = "conv1"} : memref<1x16x16x16xi6>
          } {loop_name = "xx"}
        } {loop_name = "yy"}
      } {loop_name = "ff"}
