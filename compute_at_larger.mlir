module {
  func.func @top() -> (memref<12x12xi32>, memref<10x10xi32>) attributes {itypes = "", otypes = "ss"} {
    %0 = hcl.create_op_handle "A"
    %1 = hcl.create_loop_handle %0, "y"
    %2 = hcl.create_loop_handle %0, "x"
    %3 = memref.alloc() {name = "A"} : memref<12x12xi32>
    affine.for %arg0 = 0 to 12 {
      affine.for %arg1 = 0 to 12 {
        %8 = arith.addi %arg0, %arg1 : index
        %9 = arith.index_cast %8 : index to i32
        affine.store %9, %3[%arg0, %arg1] {to = "A"} : memref<12x12xi32>
      } {loop_name = "x"}
    ...
    return %3, %7 : memref<12x12xi32>, memref<10x10xi32>
  }
}
