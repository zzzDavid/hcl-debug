module @device {
  func.func @top(%arg0: memref<10x32xi32>, %0: memref<10x32xi32>) -> () attributes {itypes = "s", otypes = "s"} {
...
module @host {
  func.func private @top(%arg0: memref<10x32xi32>, %0: memref<10x32xi32>)
  func.func @main(%arg0: memref<10x32xi32>) -> memref<10x32xi32> attributes {itypes = "s", otypes = "s"} {
    %0 = memref.alloc() {name = "B"} : memref<10x32xi32>
    func.call @top(%arg0, %0) : (memref<10x32xi32>, memref<10x32xi32>) -> ()
    affine.for %arg1 = 0 to 10 {
      affine.for %arg2 = 0 to 32 {
        %1 = affine.load %0[%arg1, %arg2] {from = "B"} : memref<10x32xi32>
        %c2_i32 = arith.constant 2 : i32
