      ...
      affine.for %arg2 = 0 to 8 {
        ...
        affine.for %arg3 = 0 to 3 {
          affine.for %arg4 = 0 to 3 {
            %10 = affine.load %arg0[%arg1 + %arg3, %arg2 + %arg4] {from = "compute_0"} : memref<10x10xi32>
        ...
        affine.store %9, %5[%arg1, %arg2] {to = "compute_1"} : memref<8x8xi32>
      } {loop_name = "x"}
    } {loop_name = "y", op_name = "compute_1"}
    %6 = hcl.reuse_at(%arg0 : memref<10x10xi32>, %1) -> memref<1xf32>
    %7 = hcl.reuse_at(%6 : memref<1xf32>, %2) -> memref<1xf32>
